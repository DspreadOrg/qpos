...
The below keyBlock parameter is TR31 data block(support B and D version) which generated by HSM. You can generate it by the below online tool for test.
[TR31 Block Online Tool](https://kabc.ca/keys/tr31)
